...
public class InterfazDeTrabajo {
	...
	private void initialize() {
		...
		JButton btnTransMinus = new JButton("Transformar a minusculas");
		GridBagConstraints gbc_lblTransMinus = new GridBagConstraints();
		btnTransMinus.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				txtFrase.setText(Utilidades.textoMinuscula(txtFrase.getText()));
			}
		});
		gbc_lblTransMinus.insets = new Insets(0, 0, 5, 5);
		gbc_lblTransMinus.gridx = 1;
		gbc_lblTransMinus.gridy = 9;
		panel_1.add(btnTransMinus, gbc_lblTransMinus);
